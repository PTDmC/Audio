...
print(device_list)
sd.default.device = [16, 4] # Input, Outputデバイス指定
...
# 更新関数 ##################################################################################################################################
def update_plot():
    global plotdata, Framesize, window, pre_data, Time, wait, detect, record, recording_data, TIME
...
"""
# グラフレイアウト設定 ######################################################################################################################
fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(16, 9), dpi = 12)
